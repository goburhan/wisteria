...
const TokensCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  return (
    <div className="bg-gray-50 mx-1 xs:mx-1 sm:mx-2 rounded-3xl shadow-sm p-5 flex flex-col items-center justify-around">
      ...
      <Link className="bg-gray-300 px-7 py-2 rounded-3xl text-primary cursor-pointer hover:opacity-75 mt-5" to="/farms">
        Farm
      </Link>
    </div>
  )
